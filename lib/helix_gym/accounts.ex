defmodule HelixGym.Accounts do
  @moduledoc """
  ...
  alias HelixGym.Repo
  alias HelixGym.Accounts.{Employee, EmployeeToken, EmployeeNotifier}
  ...
  defp employee_email_multi(employee, email, context) do
    changeset = employee |> Employee.email_changeset(%{email: email}) |> Employee.confirm_changeset()
