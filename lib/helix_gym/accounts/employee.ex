defmodule HelixGym.Accounts.Employee do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, HelixGym.Repo)
  ...
  """
  def valid_password?(%HelixGym.Accounts.Employee{hashed_password: hashed_password}, password)
