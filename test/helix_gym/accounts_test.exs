defmodule HelixGym.AccountsTest do
  use HelixGym.DataCase

  alias HelixGym.Accounts
  import HelixGym.AccountsFixtures
  alias HelixGym.Accounts.{Employee, EmployeeToken}
  ...
  describe "register_employee/1" do
    ...
    test "validates email and password when given" do
      {:error, changeset} = Accounts.register_employee(%{email: "not valid", password: "not valid"})
